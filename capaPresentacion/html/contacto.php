...
<!--
    * contacto.php
    * Modulo donde se implementa un formulario de contacto
-->
<!DOCTYPE html>
<html lang="es-ES">
    <head>
        ...
        <div class="contenido mx-auto">
            ...
            <main class="centra-form">
                ...
                if (isset($_SESSION['usuario'])) {
                    ?>
                <section>
                    <p class="mb-5">¿Quieres un juego personalizado? Contáctanos en romsland@gmail.com</p>
                </section>
                <section class="border-form">
                    <h2 class="mt-3">Contacto</h2>
                    <form action="validarContacto.php" method="POST">
                        <input type="email" placeholder="email" name="email" value="<?=$_SESSION['usuario']->getEmail();?>" readonly>
                        <input type="text" placeholder="asunto" name="asunto">
                        <div>
                            <label>Mensaje</label>
                        </div>
                        <textarea rows="5" name="mensaje"></textarea>
                        <input type="submit" value="Enviar" class="validar">
                    </form>
                </section>
                <?php
                }
