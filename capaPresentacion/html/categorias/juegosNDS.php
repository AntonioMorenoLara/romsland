...
<!--
    * juegosNDS.php
    * Modulo que implementa los juegos de Nintendo DS
-->
<!DOCTYPE html>
<html lang="es-ES">
    <head>
        ...
        <title>Juegos de Nintendo DS</title> <!--título provisional-->
        ...
        <div class="contenido mx-auto">
            ...
            <main>
                <section class="tres-columnas">
                    ...
                    $juego = new Juego();
                    $juegos = $juego->obtenerJuegosCategoria('nds');
                    ...
                    <a href="../<?php
                        ...
                        <article class="juegoCategoria article-tres-columnas">
                            ...
                            <p><?= $value->getTitulo(); ?></p>
                            <form action="../<?=$value->getModuloJuego();?>" method="POST" class="d-none">
                                <input type="hidden" name="titulo" value="<?=$value->getTitulo();?>">
                            </form>
                        </article>
                    </a>
                        <?php
